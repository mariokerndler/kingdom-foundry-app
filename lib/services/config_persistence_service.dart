...
class ConfigPersistenceService {
  ...
  ConfigState load() {
    ...
    final rules = SetupRules(
      ...
      requireReactionIfAttacks: _prefs.getBool(_kRequireReactionIfAttacks) ?? false,
      maxCost:                  maxCostVal,
  ...
  Future<void> save(ConfigState state) async {
    try {
      await Future.wait([
        ...
        _prefs.setBool(_kRequireReactionIfAttacks, state.rules.requireReactionIfAttacks),
        _prefs.setString(
          _kDisabledCards,
